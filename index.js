...
(async () => {
  ...
  for (let i = 0; i < enrollmentCardsRef.length; i++) {
    const courseHomeUrl = 'https://purdue.brightspace.com' + enrollmentCardsRef[i];
    ...
    const courseHeaderTabLinksFileName = "course" + (i+1) + "HeaderTabLinks.txt"; //the number will be the index of the for loop plus 1 when looping through multiple courses
    ...
    const courseAnnouncementsFileName = "course" + (i+1) + "Announcements.txt"; 
    ...
    const courseAnnouncementHeadersFileName = "course" + (i+1) + "AnnouncementHeaders.txt"; 
    ...
    const courseHeadersFileName = "course" + (i+1) + "Headers.txt"; 
    ...
    const courseContentTitles = await page.evaluate(() => {
      ...
      titles.forEach(title => {
        const aElement = title.querySelectorAll('.d2l-datalist-item.d2l-datalist-simpleitem');
    ...
    const courseContentFileName = "course" + (i+1) + "Content.txt"; 
    ...
    const courseGradesFileName = "course" + (i+1) + "Grades.txt"; 
